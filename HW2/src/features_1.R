...
read_motifs <- function(filename, datasetno, tr_te){
  ...
  bags = list(Label1, Label2, Label3)
  return (bags)
}
...
tf_idf <- function(bags){
  ...
  tfidf = bags_to_tfidf(list("Label1"=Label1, "Label2"=Label2, "Label3"=Label3))
  return (tfidf)
}
...
train_bags <- read_motifs('DS1motifs_train.rds', 1, "train")
